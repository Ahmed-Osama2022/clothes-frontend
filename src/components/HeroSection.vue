<template>
  <!-- ======= HERO CAROUSEL =======
       ...
       - To change the rotating order/speed: edit `setInterval(next, 5000)` in <script setup>
  ...
  <section class="relative overflow-hidden bg-snow-100">
    <div
      class="pointer-events-none absolute -right-32 -top-32 h-96 w-96 rounded-full bg-primary-200/50 blur-3xl"
    ></div>
    <div
      class="pointer-events-none absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-ink-100 blur-3xl"
    ></div>

    <div
      class="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8"
    >
      <div class="relative">
        <transition name="slide" mode="out-in">
          <div :key="current" class="space-y-6">
            ...
            <h1
              class="text-5xl font-bold leading-tight text-ink-900 sm:text-6xl"
              data-aos="fade-up"
              data-aos-delay="100"
            >
            ...
            <p
              class="max-w-md text-lg text-ink-500"
              data-aos="fade-up"
              data-aos-delay="200"
            >
            ...
            <div class="flex flex-wrap items-center gap-4 pt-2" data-aos="fade-up" data-aos-delay="300">
              <router-link
                to="/shop"
      ...
      <div class="relative hidden lg:block" data-aos="fade-left" data-aos-delay="200">
        <div class="relative mx-auto aspect-[4/5] max-w-md overflow-hidden rounded-3xl bg-gradient-to-br from-primary-100 via-snow-100 to-ink-100 shadow-xl shadow-ink-900/5">
